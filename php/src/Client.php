 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/crossword?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/crossword';
    ...
    private const VALIDATION_RULES = [
        ...
        'solutionImage' => ['type' => 'boolean', 'required' => false]
    ];
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CrosswordClient] {$message}\n";
        }
    }
}
