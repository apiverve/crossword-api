# Crossword Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:crossword-api:1.1.13'
}
```
...
```java
import com.apiverve.crossword.CrosswordGeneratorAPIClient;
import com.apiverve.crossword.APIResponse;
import com.apiverve.crossword.APIException;

// Initialize the client
CrosswordGeneratorAPIClient client = new CrosswordGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("size", "medium");
    parameters.put("theme", "random");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/crossword](https://docs.apiverve.com/ref/crossword)
...
- **Documentation:** [https://docs.apiverve.com/ref/crossword](https://docs.apiverve.com/ref/crossword)
- **Issues:** [GitHub Issues](https://github.com/apiverve/crossword-api/issues)
