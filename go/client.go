...
const (
	baseURL        = "https://api.apiverve.com/v1/crossword"
	defaultTimeout = 30 * time.Second
)

// Client is the Crossword Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Crossword Generator API client.
...
// Execute makes a request to the Crossword Generator API with typed parameters.
//
