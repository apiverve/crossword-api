...
```bash
curl -X GET "https://api.apiverve.com/v1/crossword?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/crossword](https://docs.apiverve.com/ref/crossword)

---

## Use Cases

Common use cases for the Crossword Generator API:
